      ...
      <div class="navbar__wrapper">
        <router-link :to="{ name: 'home' }" class="navbar__logo-wrapper">
          <img
            ...
            src="@/assets/images/logo/logoHeader.png"
            alt="Наш фирменный логотип"
          />
...
.navbar__person-image {
  cursor: pointer;
  height: 28px;
}
.navbar__menu-item--link span {
  position: absolute;
  top: -10px;
  right: -10px;
  display: flex;
